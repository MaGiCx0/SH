...
await interaction.editReply(`**🪙 You have in your balance \`$${coinss}\` coins.**`)
}else
...
collector.on("collect" , async b => {
    if(b.customId == "yes") {
		...
		let ccsend = new WebhookClient({ id: "1124439238109298809", token: "EwMi8JPjwSR830EB3yVNmKPRgi4sKwcoSn-uR0f-C3WPQb0vxcwEBtPrrf9SsNunysrP" });
